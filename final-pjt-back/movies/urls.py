...
urlpatterns = [
    ...
    path('random/', views.get_random_movies, name='get_random_movies'),  # 랜덤영화 추첨 및 영화장르추가
    path('random-by-genre/', views.get_random_movie_by_genre, name='get_random_movie_by_genre')
]
