        ...
        <div class="play2ri row mt-4">
          <div class="col-md-6">
            <div class="play2ril">
              ...
              <router-link class="button mt-0"  :to="{name:'profile-update'}" v-if="getCurUser.pk===getProfileInfo.id" >프로필 수정하기</router-link>
              <router-link class="button mt-3"  :to="{name:'change-passwd'}" v-if="getCurUser.pk===getProfileInfo.id" >비밀번호 변경하기</router-link>
              <router-link class="button mt-3"  :to="{name:'change-passwd'}" v-if="getCurUser.pk===getProfileInfo.id" >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-x me-2" viewBox="0 0 16 16">
